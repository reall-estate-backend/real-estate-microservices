pipeline {
    ...
    environment {
        ...
        IMAGE_NAME = 'realestate1234/user' // Replace with your Docker Hub repository name
        KUBECONFIG_CREDENTIALS_ID = 'kube-config' // Kubernetes credentials ID in Jenkins
        K8S_DEPLOYMENT_FILE = 'user-service.yml' // Path to your Kubernetes deployment file
    }
